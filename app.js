...
async function obtenerDatosAngularBlog() {
  ...
  // Crear archivo JSON
  let jsonData = JSON.stringify(datos, null, 2);
  fs.writeFileSync("angular_blog_articulos.json", jsonData, "utf-8");
  ...
  fs.writeFileSync("angular_blog_articulos.csv", csv, "utf-8");
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "Angular Blog");

  XLSX.writeFile(workbook, "angular_blog_articulos.xlsx");
